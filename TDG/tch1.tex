...
\begin{equation}
	...
	\end{cases}
\end{equation}
utilizando la relación del resultado (\ref{eq:v-sub-p}) \cite{Leveque}. Entonces, la solución al problema de Riemann tiene la forma (\ref{eq:sol-linear-sys-con-caracteristicas}), con $v_p$ definido como una función por partes.
