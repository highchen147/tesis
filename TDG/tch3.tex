...
Se puede notar que las iteraciones temporales se detienen en cuánto se alcance el número de iteraciones \texttt{Niter}, previamente definido. También destaca la expresión para \texttt{U\_N}, que emula el resultado de la ecuación \eqref{eq:mvf-U_N}, tomando en cuenta que:
\begin{equation}
